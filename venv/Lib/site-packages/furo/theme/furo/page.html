...
<div class="page">
  <header class="mobile-header">
    ...
    <div class="header-center">
      <a href="{{ pathto(master_doc) }}" class="brand-container">
      <img class="brand-logo" src="{{ pathto('_static/favicon.png', 1) }}" alt="logo">
      <div class="brand-text">{{ docstitle if docstitle else project }}</div></a>
    </div>
